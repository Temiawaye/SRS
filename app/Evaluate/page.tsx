                                ...
                                <div className="p-0 flex-1 overflow-y-auto relative srs-print-scroll">
                                    {isExternalMode ? (
                                        <div className="p-6 h-full">
                                            <textarea
                                                className="w-full h-full min-h-[400px] p-5 text-sm leading-relaxed text-slate-700 dark:text-slate-200 bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 rounded-xl focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all resize-none shadow-inner"
